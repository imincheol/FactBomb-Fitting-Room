...
| Grounding with Google Search^\*^         | Not available                                 | 5,000 prompts per month (free), then (Coming soon^\*\*^) $14 / 1,000 search queries                     |
...
| Context caching price                    | Not available                                 | $0.20, prompts \<= 200k tokens $0.40, prompts \> 200k $4.50 / 1,000,000 tokens per hour (storage price) |
| Grounding with Google Search^\*^         | Not available                                 | 1,500 RPD (free), then (Coming soon^\*\*^) $14 / 1,000 search queries                                   |
| Grounding with Google Maps               | Not available                                 | Not available                                                                                           |
| Used to improve our products             | [Yes](https://ai.google.dev/gemini-api/terms) | [No](https://ai.google.dev/gemini-api/terms)                                                            |
...
|                                                                                             |                                  Free Tier                                   |                                                                                                         Paid Tier, per 1M tokens in USD                                                                                                          |
|---------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Google Search](https://ai.google.dev/gemini-api/docs/google-search#pricing)                | 500 RPD free (limit shared for Flash and Flash-Lite). Not available for Pro. | 1,500 RPD free (limit shared for Flash and Flash-Lite). Then $35 / 1,000 grounded prompts See the[Gemini 3 Pro Preview](https://ai.google.dev/gemini-api/docs/pricing#gemini-3-pro-preview)pricing section for Gemini 3 specific Search pricing. |
...
| [Code execution](https://ai.google.dev/gemini-api/docs/code-execution#billing)              | Free of charge                                                               | Free of charge                                                                                                                                                                                                                                   |
